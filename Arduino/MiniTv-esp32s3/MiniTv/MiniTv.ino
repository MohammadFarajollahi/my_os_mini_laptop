...
#define SPI_MOSI 36  //1
#define SPI_MISO 16
#define SPI_SCK 35
#define SD_CS 37  //2
SPIClass SD_SPI;  // spi.begin(35 /* SCK */, 16 /* MISO */, 36 /* MOSI */, 37 /* CS */);

Arduino_DataBus *bus = new Arduino_ESP32SPI(39 /* DC */, 38 /* CS */, SCK, MOSI, MISO);
//Arduino_GFX *gfx = new Arduino_ST7796(bus, -1 /* RST */, 3 /* rotation */);
Arduino_GFX *gfx = new Arduino_ST7789(bus, -1, 1 /* rotation */, true /* IPS */);//, 240 /* width */, 288 /* height */, 0 /* col offset 1 */, 20 /* row offset 1 */, 0 /* col offset 2 */, 12 /* row offset 2 */);
/* variables */
...
void setup()
{
  ...
  esp_err_t ret_val = i2s_init(I2S_NUM_0, 44100, 20 /* MCLK */, 21 /* SCLK */, 47 /* LRCK */, 48 /* DOUT */, -1 /* DIN */);
 ...
 Serial.println("Init FS");
  ...
  // spi.begin(12 /* SCK */, 13 /* MISO */, 11 /* MOSI */, 7 /* CS */);
  // if (!SD.begin(7, spi, 80000000))
