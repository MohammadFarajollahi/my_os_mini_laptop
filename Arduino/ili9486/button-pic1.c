...
void create_menu() {
  ...
  lv_obj_set_scroll_dir(menu_container, LV_DIR_HOR);                // تنظیم اسکرول به سمت چپ و راست
  ...
  lv_obj_set_size(btn, 80, 80);  // اندازه دکمه‌ها
  ...
  String img_path = "/pic.bmp";  // مسیر تصویرها
  ...
  lv_obj_set_pos(btn, 100, 0);  // فاصله بین آیتم‌ها
}
