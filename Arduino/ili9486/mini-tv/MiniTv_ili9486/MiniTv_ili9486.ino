...
#define AAC_FILENAME "/file1.aac"
#define MP3_FILENAME "/file1.mp3"
// #define MP3_FILENAME "/EP05.mp3"
#define MJPEG_FILENAME "/file1.mjpeg"
...
Arduino_DataBus *bus = new Arduino_ESP32LCD16(
    15, 5, 6 /* WR */, 7 /* RD */,
    16 /* D0 */, 8 /* D1 */, 18 /* D2 */, 9 /* D3 */, 3 /* D4 */, 17 /* D5 */, 10 /* D6 */, 14 /* D7 */,
    21 /* D8 */, 47 /* D9 */, 48 /* D10 */, 35 /* D11 */, 36 /* D12 */, 37 /* D13 */, 38 /* D14 */, 1 /* D15 */);
Arduino_GFX *gfx = new Arduino_ILI9488(bus, -1, 3 /* rotation */, false /* IPS */);//, 240 /* width */, 288 /* height */, 0 /* col offset 1 */, 20 /* row offset 1 */, 0 /* col offset 2 */, 12 /* row offset 2 */);
/* variables */
...
void setup()
{
 ...
 spi.begin(12 /* SCK */, 13 /* MISO */, 11 /* MOSI */, 2 /* CS */);
  if (!SD.begin(2, spi, 80000000))
  {
