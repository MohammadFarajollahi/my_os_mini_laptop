...
#define FPS 25
#define MJPEG_BUFFER_SIZE (460 * 320 * 2 / 8)
...
#define SD_CS_PIN        2   //15  // or 5

// These pins will be use for SPI2
#define SPI_MOSI 47  //1
#define SPI_MISO 48
#define SPI_SCK 21
#define SD_CS 2  //2
SPIClass SD_SPI;

//Arduino_HWSPI *bus = new Arduino_HWSPI(15 /* DC */, 5 /* CS */, SCK, MOSI, MISO);
Arduino_DataBus *bus = new Arduino_ESP32SPI(15, 5, 36 /* SCK */, 35 /* MOSI */, GFX_NOT_DEFINED /* MISO */, HSPI /* spi_num */);
//Arduino_GFX *gfx = new Arduino_ST7796(bus, -1 /* RST */, 3 /* rotation */);
Arduino_GFX *gfx = new Arduino_ST7796(bus, -1, 1 /* rotation */, false /* IPS */);//, 320 /* width */, 480 /* height */, 0 /* col offset 1 */, 20 /* row offset 1 */, 0 /* col offset 2 */, 12 /* row offset 2 */);
//Arduino_GFX *gfx = new Arduino_ST7789(bus, -1, 1 /* rotation */, true /* IPS */);//, 240 /* width */, 200 /* height */, 0 /* col offset 1 */, 20 /* row offset 1 */, 0 /* col offset 2 */, 80 /* row offset 2 */);
/* variables */
...
void setup()
{
  ...
  esp_err_t ret_val = i2s_init(I2S_NUM_0, 44100, 4 /* MCLK */, 6 /* SCLK */, 16 /* LRCK */, 17 /* DOUT */, 18 /* DIN */);
  ...
  //spi.begin(12 /* SCK */, 13 /* MISO */, 11 /* MOSI */,  SS/* CS */);
  //SPIClass SPI2(HSPI);
//SPI2.begin(SS, 12, 11, 13);
